...
try {
    ...
    $booking_code = 'JCY' . date('Ymd') . '-' . strtoupper(substr(md5($custom_tour_id . time()), 0, 4));
    ...
    // Prepare Telegram message with improved formatting
    $message = "<b>📢 New Custom Tour Booking Received!</b>\n\n" .
        ...
        "• <b>Address:</b> $address, $street_no, $city, $country, ZIP: $zip\n" .
        ...
        "• <b>Number of Adults:</b> $num_adults\n" .
        "• <b>Number of Children:</b> $num_children\n" .
        "• <b>Hotel Rooms:</b> $hotel_room_amount\n" .
        "• <b>Budget Per Person:</b> $" . number_format($budget_per_person, 2) . "\n" .
        "• <b>Destination(s):</b> $destination\n" .
        "• <b>Tour Type:</b> $tour_type_name\n" .
        "• <b>Accommodation Type:</b> $accommodation_type_name\n\n" .
        ...
        "<b>💳 Payment & Flight</b>\n" .
        "• <b>Payment Method:</b> $pay_method_name\n" .
