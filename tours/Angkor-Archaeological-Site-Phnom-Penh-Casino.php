...
<main class="main">
  ...
  <section id="travel-tour-details" class="travel-tour-details section">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
      ...
      // e.g. angkor-archaeological-site-phnom-penh-casino.php => angkor-archaeological-site-phnom-penh-casino
            ...
            <div class="col-md-7">
              ...
              <div class="d-flex justify-content-between align-items-center flex-wrap mt-4">
                ...
                <div class="mt-2 mt-md-0">
                  ...
                  <button id="bookNowBtn" class="btn pkg-btn-blue" type="button">Book Now</button>
                </div>
              </div>
            </div>
  ...
  <div id="popupAlert" class="popup-alert">
    <div class="popup-alert-content">
      <div id="popupAlertIcon" class="popup-alert-icon">⚠️</div>
      <div id="popupAlertTitle" class="popup-alert-title">Alert</div>
      <div id="popupAlertMessage" class="popup-alert-message">Message</div>
      <button id="popupAlertButton" class="popup-alert-button" onclick="closePopupAlert()">OK</button>
    </div>
  </div>
